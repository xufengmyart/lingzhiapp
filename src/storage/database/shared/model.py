...
from sqlalchemy import Boolean, Column, DateTime, Double, ForeignKeyConstraint, Index, Integer, JSON, Numeric, PrimaryKeyConstraint, String, Table, Text, UniqueConstraint, text
...
class Users(Base):
    ...
    emotion_diaries: Mapped[list['EmotionDiaries']] = relationship('EmotionDiaries', back_populates='user')
    emotion_records: Mapped[list['EmotionRecords']] = relationship('EmotionRecords', back_populates='user')
...
class EmotionDiaries(Base):
    ...
    intensity: Mapped[float] = mapped_column(Double(53), nullable=False)
    created_at: Mapped[datetime.datetime] = mapped_column(DateTime, nullable=False, server_default=text('now()'))
    tags: Mapped[Optional[dict]] = mapped_column(JSON)

    user: Mapped['Users'] = relationship('Users', back_populates='emotion_diaries')
...
class EmotionRecords(Base):
    ...
    user: Mapped['Users'] = relationship('Users', back_populates='emotion_records')
