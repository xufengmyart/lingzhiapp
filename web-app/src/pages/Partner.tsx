  ...
  const handleSubmitApplication = async (e: React.FormEvent) => {
    ...
    try {
      await partnerApi.submitApplication({
        ...
        currentLingzhi: user!.total_lingzhi,
                ...
                <div className="border rounded-xl p-6">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between">
                      ...
                      <span className="font-semibold text-primary-600">{user?.total_lingzhi} 灵值</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">距离资格</span>
                      <span className="font-semibold text-secondary-600">
                        {Math.max(0, 10000 - user!.total_lingzhi)} 灵值
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-gray-600">资格状态</span>
                      <span className={`font-semibold ${
                        user!.total_lingzhi >= 10000 ? 'text-green-600' : 'text-orange-600'
                      }`}>
                        {user!.total_lingzhi >= 10000 ? '✅ 已达成' : '⏳ 进行中'}
                      </span>
                    </div>
                  </div>
                </div>
            ...
            <div className="max-w-2xl mx-auto">
              <div className="mb-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <p className="text-sm text-blue-700">
                  💡 提示：您需要累计获得 10,000 灵值才能申请成为合伙人。当前您有 {user?.total_lingzhi} 灵值。
                </p>
              </div>

              {user!.total_lingzhi >= 10000 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 mt-2">
                    继续积累灵值，距离合伙人资格还有 {10000 - user!.total_lingzhi} 灵值
                  </p>
                </div>
              )}
            </div>
