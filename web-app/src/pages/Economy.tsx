...
import { Wallet, TrendingUp, Lock, Calculator, PieChart } from 'lucide-react'
import DividendPoolView from '../components/DividendPoolView'

const Economy = () => {
  const [activeTab, setActiveTab] = useState<'income' | 'calculator' | 'exchange' | 'dividend'>('income')
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="flex border-b">
          {[
            ...
            { id: 'dividend', icon: PieChart, label: '分红池' },
